    ...
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                ...
                <div class="row">
                   <form method="post" action="/BOXUEYUAN1/index.php/Admin/admin/doPass">
                    <table>
                            <tr>
                                <td>用户名称:<span>*</span></td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="username" id="admin-username" value="3" readonly></td>
                            </tr>
                            <tr>
                                <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:<span>*</span></td>
                                <td>&nbsp;</td>
...
<script src="/BOXUEYUAN1/Public/after/js/save.js"></script>
