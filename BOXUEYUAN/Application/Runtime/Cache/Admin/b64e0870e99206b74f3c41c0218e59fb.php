...
<head>
  ...
  <link rel="stylesheet" href="/BXY/Public/after/css/bootstrap.min.css"> 
   <link rel="stylesheet" href="/BXY/Public/after/css/admincss.css">  
    ...
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
               <div class="col-md-2 column" id="admin-list">
                <img alt="140*140" src="/BXY/Public/after/images/logo.png" width="70%" id="logopic"/>
              ...
              <div class="col-md-10 column">
                ...
                <div class="row" id="admin-table">
                  <div class="row">
                   <form method="post" action="/BXY/index.php/Admin/admin/doEdit">
                    <input type="hidden" name="ID" value="<?php echo ($administrator["gid"]); ?>">
                   <table>
                      <tr>
                          <td>用户名称:<span>*</span></td>
                            ...
                            <tr>
                                <td>注册时间:<span>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><input type="data" name="time" id="admin-time"value="<?php echo ($administrator["registertime"]); ?>"></td>
                            </tr>
...
<script src="/BXY/Public/after/js/null.js"></script> 
...
<script src="/BXY/Public/after/js/jquery.js"></script>    
<script src="/BXY/Public/after/js/bootstrap.min.js"></script>
<!-- <script src="/BXY/Public/after/js/null_user.js"></script> -->
