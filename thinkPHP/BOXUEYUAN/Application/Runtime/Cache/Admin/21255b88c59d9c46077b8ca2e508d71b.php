  ...
  <div class="row clearfix">
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
              ...
              <form  action="/BOXUEYUAN/index.php/Admin/Teacher/del" role="form" >
              <div class="row" id="add-del">                
                <div class="col-md-2 column">
                	  <button><span class="glyphicon  glyphicon-user"></span><a href="<?php echo U('Admin/Teacher/teacher_add');?>">添加名师</a></button>
		            </div>	       
		            <div class="col-md-2 column">
              ...
              <div class="row" id="admin-table">         
                <table class="table" style="margin-left:-40px">
                  ...
                  <?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><tr >
                    ...
                    <td> <a href="del/id/<?php echo ($t["tid"]); ?>">删除</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="teacher_edit/id/<?php echo ($t["tid"]); ?>">编辑</a></td>
