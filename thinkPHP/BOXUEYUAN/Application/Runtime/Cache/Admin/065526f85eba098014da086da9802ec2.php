    ...
    <div class="col-md-12 column">
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-10 column">
                ...
                <form  action="/BOXUEYUAN/index.php/Admin/News/del" role="form" > 
                <div class="row" id="add-del">                
                  <div class="col-md-2 column">
                     <button><span class="glyphicon  glyphicon-user"></span><a href="<?php echo U('Admin/News/add');?>">添加新闻</a></button>
                  </div>           
                  <div class="col-md-2 column">
                ...
                <table class="table"  style="margin-left:-40px">
                  ...
                  <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newse): $mod = ($i % 2 );++$i;?><tr >
                    ...
                    <td>
                      ...
                      <td>
                        <a href="/BOXUEYUAN/index.php/Admin/News/edit/id/<?php echo ($newse["id"]); ?>">编辑</a>&nbsp;/&nbsp;<a href="/BOXUEYUAN/index.php/Admin/News/del/id/<?php echo ($newse["id"]); ?>">删除</a>
                      </td>
